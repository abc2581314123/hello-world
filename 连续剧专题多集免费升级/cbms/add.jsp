...
<html lang="zh">
	...
	<body class="easyui-layout" id="bodyid">
		<div data-options="region:'center',title:'专题管理〉新增专题'" border="false" style="background-color:#C4C4C4">
		    <!--form表单页面-->
		    <form action="special_save.do" method="post" id="form1" enctype="multipart/form-data">
				...
				<div>
		        	<ul class="addOneRow">
			          	<li>
			            	...
			            	<input type="text" id="name" maxlength="50" name="vo.name"/>
			          	</li>
		        	</ul>
		        	<ul class="addOneRow">
		        		<li>
			            	...
			            	<input type="text" id="priority" name="vo.priority" maxlength="3" style="display: none" onKeyUp="value=value.replace(/[^\d]/g, '')"/><a href="javascript:void(0)" id="prioritynum" style="display: none">（1~100）数字越大，优先级越高。</a>
						</li>
		        	</ul>
		        	<ul class="addOneRow">
		        		<li>
		        	...
		        	<ul class="timeRow" id="timeRow" style="display: none">
		        		<li style="width: 1000px; margin-top: 0px" name="addtimeli" id="addtime" >
					...
					<div class="mb10">
						<ul class="oneRow">
							...
							<li style="margin-left: 10px;">
								<a href="javascript:void(0)" class="btn btn-primary" data-options="iconCls:'icon-add',plain:true" onclick="searchPcode()">查询</a> 
							</li>
						</ul>
					</div>
					<!-- 下表格 -->
				...
				<div>
					...
					<div style="overflow:hidden; margin-left: 200px;">
						<div style="float:left;width:445px; height:122px; margin-top: 88px;">
							<img id="src1" src="resource/image/placeholder_u204.png" alt="" width="236" height="122"/>
						...
						<div style="float:left;width:333px; height:212px">
							<img id="src2" src="resource/image/placeholder_u206.png" alt="" width="165" height="208"/>
							<div style="display:inline-block">
					...
					<div style="margin-left: 350px;">
						<img id="src3" src="resource/image/blue.jpg" alt="" width="236" height="122"/>
						<div style="display:inline-block">
