...
if(GOTOType.indexOf("E900")>=0||GOTOType.indexOf("B860AV1.1")>=0||GOTOType.indexOf("EC6108V9")>=0||GOTOType.indexOf("HG680-RLK9H-12")>=0||GOTOType.indexOf("HG680-L")>=0||GOTOType.indexOf("EC6109U")>=0||GOTOType.indexOf("B860AV2.2")>=0||GOTOType.indexOf("HG680-r")>=0){	
	document.getElementById("posterPic2").src = "images/adimages/hwtb.jpg";	
//posterPic posterDiv
<%-- document.getElementById("urlad2").setAttribute("data-url",recommendList_all[81][picIndexLeftBot].vasUrl+"&providerid=hw&iaspuserid=<%=iaspuserid%>&iaspadsl="+NetUserID+"&iaspip=<%=iaspip%>&iaspmac=<%=iaspmac%>&right=0&down=1"); --%>
document.getElementById("posterDiv2").href="adijsp/v10/commonwealpage/commonwealpage.jsp?code=21100001000000011509434086435002&providerid=hw&iaspuserid=<%=iaspuserid%>&iaspadsl="+NetUserID+"&iaspip=<%=iaspip%>&iaspmac=<%=iaspmac%>&right=0&down=1";
}else{
document.getElementById("posterPic2").src = "images/adimages/hwtb.jpg";	
...
//posterPic posterDiv
<%-- document.getElementById("urlad2").setAttribute("data-url",recommendList_all[3][picIndexLeftBot].vasUrl+"&providerid=hw&iaspuserid=<%=iaspuserid%>&iaspadsl="+NetUserID+"&iaspip=<%=iaspip%>&iaspmac=<%=iaspmac%>&right=0&down=1"); --%>
document.getElementById("posterDiv3").href="adijsp/v10/commonwealpage/commonwealpage.jsp?code=21100001000000011511150104427001&category_id=1001007001004&providerid=hw&foucsid=dy_page_right3&backflag=0&jumpflag=2&backurlnosession=http%3A//218.24.37.2/templetshd/epg/dy_page.jsp%3Fcategoryid%3D1001007001004%26parentid%3D1001007001%26providerid%3Dzx%26backflag%3D0%26rtoone%&iaspuserid=<%=iaspuserid%>&iaspadsl="+NetUserID+"&iaspip=<%=iaspip%>&iaspmac=<%=iaspmac%>&right=0&down=1";
}
	var isFromVas = false; 
</script> 
<%
...
function ZanTing(){
window.location.href="adijsp/v10/commonwealpage/commonwealpage.jsp?code=21100001000000011511144624683001&category_id=1001007002001&providerid=hw&foucsid=dy_page_right2&backflag=0&jumpflag=2&backurlnosession=http%3A//218.24.37.2/templets/epg/dy_page.jsp%3Fcategoryid%3D1001007002001%26parentid%3D1001007002%26providerid%3Dhw%26backflag%3D0%26rtoone%&iaspuserid=<%=iaspuserid%>&iaspadsl="+NetUserID+"&iaspip=<%=iaspip%>&iaspmac=<%=iaspmac%>&right=0&down=1";
}
...
<div id="test" style="position:absolute; left:58px; top:33px; width:490px; height:107px; color:#FFFFFF"></div>
