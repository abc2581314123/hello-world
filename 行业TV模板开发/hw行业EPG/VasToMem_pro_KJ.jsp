...

         {
...

					{
							...
							<script>
								...
								window.location.href = "play_controlVod_bf_KJ.jsp?PROGID=<%=progId%>&FATHERSERIESID=<%=FATHERVODID%>&backurl=<%=vas_back_url%>&PLAYTYPE=1&vasFlag=1&spflag=sp&hwType=<%=hwType%>";
