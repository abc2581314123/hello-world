...
<script src="js/allChannel.js"></script>
<script src="js/v15_allChannel_1.js"></script>
<script src="js/v15_allChannel_2.js"></script>
<script src="js/v15_allChannel_3.js"></script>
<script src="js/v15_allChannel_4.js"></script>
<script src="js/v15_allChannel_5.js"></script>
<script src="js/v15_allChannel_6.js"></script>
<script src="js/v15_allChannel_7.js"></script>
<title>PlayControleChannel.jsp华为直播控制页</title>
<style type="text/css">
.icon{
	position:absolute ;
	width:10px;
...
<script>
    ...
    {   
...

        {
			...
			case <%=KEY_VOD%>:
					pr2.servletSubmit("1","removeOnPlayUser",currChannel);
					setTimeout("yellowgo()",500);					
					break;
			case <%=KEY_INFO%>:
			case <%=KEY_BLUE%>:
			case <%=KEY_FAVORITE%>:
				    pr2.servletSubmit("1","removeOnPlayUser",currChannel);
					setTimeout("bluego()",500);
					break;
			case <%=KEY_TVOD%>:
			case <%=KEY_GREEN%>:
					pr2.servletSubmit("1","removeOnPlayUser",currChannel);
...
if(getCookie("focusIndexma")=="1"){
     if(chanNums[currChanIndex]=="20"){
     	setCookie("focusIndexma","0");
document.location.href = "http://202.97.183.159:9090/templets/springChannel/SFchannel.jsp?providerid=hw&focusIndex2=0"

     }


         else if(chanNums[currChanIndex]=="52"){
          	     	setCookie("focusIndexma","0");
document.location.href = "http://202.97.183.159:9090/templets/springChannel/SFchannel.jsp?providerid=hw&focusIndex2=1"

     }
         else if(chanNums[currChanIndex]=="47"){
          	     	setCookie("focusIndexma","0");
document.location.href = "http://202.97.183.159:9090/templets/springChannel/SFchannel.jsp?providerid=hw&focusIndex2=2"

     }
         else if(chanNums[currChanIndex]=="49"){
          	     	setCookie("focusIndexma","0");
document.location.href = "http://202.97.183.159:9090/templets/springChannel/SFchannel.jsp?providerid=hw&focusIndex2=3"

     }
         else if(chanNums[currChanIndex]=="46"){
          	     	setCookie("focusIndexma","0");
document.location.href = "http://202.97.183.159:9090/templets/springChannel/SFchannel.jsp?providerid=hw&focusIndex2=4"

     }
         else if(chanNums[currChanIndex]=="45"){
          	     	setCookie("focusIndexma","0");
document.location.href = "http://202.97.183.159:9090/templets/springChannel/SFchannel.jsp?providerid=hw&focusIndex2=5"
 ...
 if (isFromVas) document.location.href = "backToVis.jsp";
   ...
   if(pltvStatusFlag == 0 || channelJoined == 0)
	...
	var channelUrl="channel_adi.jsp?1=1";
	var channelPic="images/adimages/hwht.jpg";
    function init()

    {
		
		    
        if(getCookie("zbFlag")=="ture"){
		var urls=location.href.replace("play_ControlChannel.jsp","play_ControlChannel_new.jsp");
		window.location.href=urls;
		}else if(getCookie("zbFlag")=="false"){
      var urls=location.href.replace("play_ControlChannel.jsp","play_ControlChannel_pro.jsp");
		window.location.href=urls;
        ...
        //genSeekTable();  //delete by duanxiaohui	
 	    ...
 	    filmInfoDiv3 = document.getElementById("filmInfo23"); 
		...
		// 增加静音的判断
        //链接的图片
		//document.getElementById("show_pic").src = "images/adimages/hwht.jpg" ;
        //if(mp.getMuteFlag() == 1 && (mp.getNativeUIFlag() == 0 && mp.getMuteUIFlag() == 0))
        //直播视频页初始显示节目信息
		var GOTOType =Authentication.CTCGetConfig("STBType");
	if(GOTOType.indexOf("EC6108V9")>=0||GOTOType.indexOf("B860AV1.1")>=0||GOTOType.indexOf("E900")>=0||GOTOType.indexOf("HG680-RLK9H-12")>=0||GOTOType.indexOf("EC6109U")>=0||GOTOType.indexOf("B860AV1.1")>=0||GOTOType.indexOf("B860AV")>=0){
        setTimeout("showInfo1();",1000);
		setTimeout("hideInfo();",8000);
		setTimeout("Spstatic_H5()",300000);
	...
	//正常探针
		...
		var adlog= 'http://218.24.37.2/templets/epg/spstatistics_HD.jsp?deviceToken=<%=iaspuserid%>&iaspip=<%=iaspip%>&iaspmac=<%=iaspmac%>&boxType='+boxType+'&hdType='+hdType+'&boxCity='+boxCity+'&stbId='+stbId+'&pageID='+pageID+'&orignal=5&adType=3';
			 ...
			 xmlhttpforadlog.onreadystatechange = handlelogResponse2; 
			 xmlhttpforadlog.setRequestHeader("If-Modified-Since", "0");
			 xmlhttpforadlog.send(null); 
    }
    	function handlelogResponse2() 
			 { 
				 if(xmlhttpforadlog.readyState == 4 && xmlhttpforadlog.status==200) 
				 { 
				 } 
			 }
    	function Spstatic_H5()
	{
		var adlog ="";
var GOTOType1 =Authentication.CTCGetConfig("STBType");
		if(GOTOType1.indexOf("B860AV1.1")>=0 ||GOTOType1.indexOf("HG680-RLK9H-12")>=0||GOTOType1.indexOf("EC6108V9")>=0||GOTOType1.indexOf("E900")>=0||GOTOType1.indexOf("EC6109U")>=0||GOTOType1.indexOf("B860AV")>=0){		
	
		 adlog ='http://202.97.183.77:91/loginterface/irts?platform=hw&version=1.5&userId=<%=iaspuserid%>&rtsType=2&contentId='+chanNums[currChanIndex];
		
		}else{
	     adlog ='http://202.97.183.77:91/loginterface/irts?platform=hw&version=1.0&userId=<%=iaspuserid%>&rtsType=2&contentId='+chanNums[currChanIndex];
		}
		...
		var xmlhttpforadlog; 
	    	...
	    	function AddSpstatic_H5(number)
	{
		var adlog ="";
var GOTOType1 =Authentication.CTCGetConfig("STBType");
		if(GOTOType1.indexOf("B860AV")>=0 ||GOTOType1.indexOf("HG680-RLK9H-12")>=0||GOTOType1.indexOf("EC6108V9")>=0||GOTOType1.indexOf("E900")>=0||GOTOType1.indexOf("EC6109U")>=0){		
		 ...
		 adlog ='http://202.97.183.77:91/loginterface/irts?platform=hw&version=1.5&userId=<%=iaspuserid%>&rtsType=2&contentId='+number;
		
		}else{
	     adlog ='http://202.97.183.77:91/loginterface/irts?platform=hw&version=1.0&userId=<%=iaspuserid%>&rtsType=2&contentId='+number;
		}
...

    {
	    ...
	    //从allChannel.js中获取图片和路径
		for(var i=0;i<allChannel.length;i++)
		{
		 
		if(allChannel[i].channelId==chanNums[currChanIndex])
		{
		channelUrl=allChannel[i].zbUrl;
		channelPic=allChannel[i].zbPic;
		break;
		}
		else{
		channelUrl="channel_adi.jsp?1=1";
	    channelPic="images/adimages/hwht.jpg";
		}
		}
		//链接的图片
		document.getElementById("show_pic").src = channelPic ;
        JbFlag = "open";
    	if (hideTimer != "")
...

		{
			...
			filmInfo.location.href = "MiniInfoChannel.jsp?ChannelId=" + currChannelId + "&pltvStatusFlag=" + pltvStatusFlag;
...

		{
			...
			filmInfo.location.href = "MiniInfoChannel.jsp?ChannelId=" + chanIds[currChanIndex] + "&pltvStatusFlag=" + pltvStatusFlag;
...
{
case 0:
		for(var i=0;i<allChannel7.length;i++)
		{
		 
		if(allChannel7[i].channelId==chanNums[currChanIndex])
		{
		channelUrl=allChannel7[i].zbUrl;
		channelPic=allChannel7[i].zbPic;
		break;
		}
		else{
		channelUrl="channel_adi.jsp?1=1";
  ...
  break;
case 1:
		for(var i=0;i<allChannel1.length;i++)
		{
		 
		if(allChannel1[i].channelId==chanNums[currChanIndex])
		{
		channelUrl=allChannel1[i].zbUrl;
		channelPic=allChannel1[i].zbPic;
		break;
		}
		else{
		channelUrl="channel_adi.jsp?1=1";
  ...
  break;
case 2:
		for(var i=0;i<allChannel2.length;i++)
		{
		 
		if(allChannel2[i].channelId==chanNums[currChanIndex])
		{
		channelUrl=allChannel2[i].zbUrl;
		channelPic=allChannel2[i].zbPic;
		break;
		}
		else{
		channelUrl="channel_adi.jsp?1=1";
  ...
  break;
case 3:
		for(var i=0;i<allChannel3.length;i++)
		{
		 
		if(allChannel3[i].channelId==chanNums[currChanIndex])
		{
		channelUrl=allChannel3[i].zbUrl;
		channelPic=allChannel3[i].zbPic;
		break;
		}
		else{
		channelUrl="channel_adi.jsp?1=1";
  ...
  break;
case 4:
		for(var i=0;i<allChannel4.length;i++)
		{
		 
		if(allChannel4[i].channelId==chanNums[currChanIndex])
		{
		channelUrl=allChannel4[i].zbUrl;
		channelPic=allChannel4[i].zbPic;
		break;
		}
		else{
		channelUrl="channel_adi.jsp?1=1";
  ...
  break;
case 5:
		for(var i=0;i<allChannel5.length;i++)
		{
		 
		if(allChannel5[i].channelId==chanNums[currChanIndex])
		{
		channelUrl=allChannel5[i].zbUrl;
		channelPic=allChannel5[i].zbPic;
		break;
		}
		else{
		channelUrl="channel_adi.jsp?1=1";
  ...
  break;
case 6:
		for(var i=0;i<allChannel6.length;i++)
		{
		 
		if(allChannel6[i].channelId==chanNums[currChanIndex])
		{
		channelUrl=allChannel6[i].zbUrl;
		channelPic=allChannel6[i].zbPic;
		break;
		}
		else{
		channelUrl="channel_adi.jsp?1=1";
  ...
  break;
		...
		//链接的图片
		document.getElementById("show_pic1").src = channelPic ;
        JbFlag = "open";
    	if (hideTimer != "")
...

		{
			...
			filmInfo.location.href = "v15_MiniInfoChannel.jsp?ChannelId=" + currChannelId + "&pltvStatusFlag=" + pltvStatusFlag;
...

		{
			...
			filmInfo.location.href = "v15_MiniInfoChannel.jsp?ChannelId=" + chanIds[currChanIndex] + "&pltvStatusFlag=" + pltvStatusFlag;


			// 四秒后隐藏提示信息

			hideTimer = setTimeout("hideInfo();",7000);
...

	{
        ...
        filmInfoDiv2.style.display="block";
			 filmInfoDiv3.style.display="none";
...

	{
		 ...
		 filmInfoDiv.style.display="block";
		 filmInfoDiv3.style.display="block";
...

    {
...

        {
        	...
        	{
          		var GOTOType =Authentication.CTCGetConfig("STBType");
	if(GOTOType.indexOf("EC6108V9")>=0||GOTOType.indexOf("B860AV1.1")>=0||GOTOType.indexOf("E900")>=0||GOTOType.indexOf("HG680-RLK9H-12")>=0||GOTOType.indexOf("EC6109U")>=0){
        		showInfo1();
 ...
 
    {
...

        {
            ...
            clearTimeout(AddClearTime);

        }
	    //isControlChanIndex = -1;
      AddClearTime = setTimeout("AddSpstatic_H5("+(chanNums[currChanIndex])+")",300000);
    ...
    currChanIndex = currChanIndex - 1;
	    ...
	    //isControlChanIndex = -1;
      AddClearTime = setTimeout("AddSpstatic_H5("+(chanNums[currChanIndex])+")",8000);
		...
		if(Number(currChannel)==1){
		var GOTOType =Authentication.CTCGetConfig("STBType");
		if(GOTOType.indexOf("B860AV1.1")>=0||GOTOType.indexOf("HG680-RLK9H-12")>=0 ||GOTOType.indexOf("EC6108V9")>=0||GOTOType.indexOf("E900")>=0||GOTOType.indexOf("EC6109U")>=0||GOTOType.indexOf("HG680-L")>=0){	
		currChanIndex =  chanSize - 14;
		}else{
		currChanIndex =  chanSize - 14;
		}
    ...
    */
...

    {
       ...
       //timePerCell =  mediaTime / 100;
		...
		document.getElementById("progressBar").style.width = currCellCount / 100 * 470 + "px";
...
<div id="bottomframe" style="position:absolute;left:65px; top:400px; width:600px; height:150px; z-index:1;display:none">
    <div id="volume_bar">
		...
		<div id="volumeValue" style="position:absolute;left:470px;top:2;width:40px;color:#FFFFFF;font-size:36px;"></div>
	</div>
</div>
...
<!-- 直播节目信息条-->
<div id="filmInfo22" style="position:absolute;width:80px; height:100px;left:537px;top:366px; z-index:3;"> 
<a href = "#"><img id ="show_pic" src = "" width="80px" height="100px"></a></div>

<div id="filmInfo23" style="position:absolute;width:220px; height:160px;left:400px;top:366px; z-index:3;"> 
<a href = "#"><img id ="show_pic1" src = "" width="220px" height="160px"></a></div> 
<div id="filmInfo1" style="position:absolute;left:20px; top:366px; width:600px; height:164px; z-index:1;">

   <iframe name="filmInfo" id="filmInfo" src="" scroll="no" height="164px" width="600px" bgcolor="transparent" allowtransparency="true" frameborder="0" style="border:0px;">
...
<div  id="seekDiv" style="position:absolute;width:640px;height:200px;left:0px;top:300px; z-index:1;display:none;">

    <!-- 进度条中显示的百分比 -->

    <div id="seekPercent" style="position:absolute;color:#FFFFFF;width:45;height:30;top:24%;left:311;z-index:3; font-size:22px;"></div>

    <!-- 进度条所在div -->

    <div style="position:absolute;width:640;height:80;left:0;top:0;z-index:-2;">

    <img class="alpha" id="" width="640" height="80" src="images/playcontrol/bg-seek.gif">

    </div>

    <div id="" style="position:absolute;width:640;height:80;left:0;top:0;z-index:2;color:white;">
                ...
                <td height="40">
                    ...
                    <table width="465" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td id="currTimeShow" width="275" valign="middle" align="right" style="font-size:22px; color:#FFF;"></td>
                ...
                <td width="465" valign="top">
                   ...
                   <table width="" height="" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td width="465" height="30" bgcolor="#000080">
  ...
  <tr>
    ...
    <div id="jumpTimeImg" style="position:absolute;width:640;height:76;left:0;top:82;z-index:-9;">

    <img class="alpha"  id="" width="640" height="76" src="images/playcontrol/playChannel/bg-seek.gif">

    </div>

    <div id="jumpTimeDiv" style="position:absolute;width:640;height:76;left:0;top:82;z-index:9;color:white;">

	<form  name="passForm" action="javascript:clickJumpBtn()">

        <table width="640" height="76" border="0" cellpadding="0" cellspacing="0" style="font-size:22px;">
            ...
            <tr height="36">
                ...
                <td width="180" height="36" valign="middle" align="center" style="font-size:22px; color:#fff;">跳转到</td>



                <td width="40" valign="middle" align="center">

                    <input id="jumpTimeHour" type="text" maxlength="3" style="width:40px; height:28px; line-height:28px; display:inline-block;  font-size:22px"/> 

                </td>

                <td width="30" valign="middle" align="center" style="font-size:22px; color:#fff;">时</td>

                <td width="40" valign="middle" align="center">

                    <input id="jumpTimeMin" type="text" maxlength="3" style="width:40px; height:28px;  font-size:22px"/> 

                </td>

                <td width="30" valign="middle" align="center" style="font-size:22px; color:#fff;">分</td>
            ...
            <tr>
                ...
                <td id="timeError" width="640" height="30" valign="middle" align="center" colspan="6" style="color:DAA520;  font-size:22px;"></td>
