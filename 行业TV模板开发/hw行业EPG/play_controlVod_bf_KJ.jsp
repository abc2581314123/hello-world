				...
				if(null != preMap)
				{
					...
					if(tempSitcom == 1)   //是连续剧
					{
						...
						if(null !=sitArray && sitArray.size() > 0)
						{
							...
							preFilmUrl = "au_PlayFilm_pro.jsp?TYPE_ID="+typeId
							+"&PROGID="+ sitVodId
				...
				if(null != nextMap)
				{
					...
					if(tempSitcom == 1)   //是连续剧
					{
						...
						if(null !=sitArray && sitArray.size() > 0)
						{
							...
							nextFilmUrl = "au_PlayFilm_pro.jsp?TYPE_ID="+typeId
							+"&PROGID="+ sitVodId
							+"&PLAYTYPE="+ EPGConstants.PLAYTYPE_VOD 
							+ "&CONTENTTYPE=" + EPGConstants.CONTENTTYPE_VOD_VIDEO
							+ "&BUSINESSTYPE=" + EPGConstants.BUSINESSTYPE_VOD
	    ...
	    inputNum(0);
            ...
            // 退出
            	if(isrecom) {
            		...
            		document.getElementById("bfmovie").style.display = 'block'
            		isrecom = false;
            		return;
            	}
             	if(iframeFlag=="close"||tzFlag=="close"){
            ...
            case <%=KEY_IPTV_EVENT%>:
             ...
             case <%=KEY_OK%>:
             		if(!isrecom && (iframeFlag=="close"||tzFlag=="close")) {
                 
             			document.getElementById('rightPop').style.display = 'block'
	             		isrecom = true
	             		document.getElementById('tj_1').onfocus()
	             		if(nextEpisId != -1){
	             			document.getElementById('controlD').innerHTML += '<a href="javascript:nextPlay()"><img src="./images/next.png"></a>'
	             		}
	             		if(preEpisId != -1){
	             			document.getElementById('controlD').innerHTML = '<a href="javascript:prePlay()"><img src="./images/pre.png"></a>' + document.getElementById('controlD').innerHTML
	             		}
	             		  getGGData(addatas);
...
/////书签添加////////=============wsj=======//////////
...

    {
	    ...
	    if(GOTOType.indexOf("E900")>=0||GOTOType.indexOf("B860AV1.1")>=0){		
		   ...
		   document.getElementsByClassName('rpnb')[0].style.width = ((toSeconds(document.getElementById('ctime').innerHTML)/toSeconds(document.getElementById('ttime').innerHTML)) * 200) +'px'
        return;
        }
	    if(disLockFlag == 1) return;
...
//		OjFlag="open";
		...
		//跳转行业EPG首页
		  setTimeout(function(){
       window.location.href = Authentication.CTCGetConfig("ProfessionURL");
		  },15000)
    }
...
if(playStat == "play")  //重点
        ...
        {//显示暂停广告
            ...
            pause();
            document.getElementById('rppp').innerHTML = '<img src="./images/play.png">'
            //displaySeekTable();
           tcFlag=1;
            return;
...

        {
            ...
            resume();
            tcFlag=0;
            document.getElementById('rppp').innerHTML = '<img src="./images/pause.png">'
            //displaySeekTable();
...

    {
        ...
        mp.stop();
        var tmpUrl = "au_PlayFilm_pro.jsp?TYPE_ID="+"<%=typeId%>"+"&PROGID=" + preEpisId
    ...
    function nextPlay()
    {
        ...
        mp.stop();
        var tmpUrl  = "au_PlayFilm_pro.jsp?TYPE_ID="+"<%=typeId%>"+"&PROGID=" + nextEpisId;
...

    {
        ...
        */
...

        {
            ...
            document.getElementById('ttime').innerHTML = fullTimeForShow
    ...
    */
...

    {
        ...
        */
        ...
        document.getElementById('ttime').innerHTML = returnTime
        return returnTime;
...
{        
  ...
  if(actionType=="2"){
     dataurl = "http://202.97.183.28:9090/templets/epg/Profession/det_tz.jsp?code="+code+"&category_id="+categoryid+tempstr;
   }
    
   
}
document.getElementById("tj_1").href = dataurl;
...
<style>
	* { padding: 0; margin:0;}
	#rightPop { position: absolute; height: 530px; width: 250px; display: none; background: url('./images/ctbg.png') no-repeat; top: 0; right: 0; }
	.recImg {
        width: 200px;
        height: 330px;
        background: red;
...
<div id="rightPop">
	<h5 style="width: 100%; text-align: center; line-height: 30px; color: #fff;">您正在收看的是</h5>
	<h5 id="h31" style="width: 100%; text-align: center; line-height: 40px; color: #fff;"></h5>
	<div class="recImg"><a href="#" id="tj_1"><img id="img1" src="images/vod_1.jpg" width="200" height="330"></a></div>
	<div id="controlD">
		<!-- <a href="javascript:prePlay()">上一集</a> -->
		<a href="javascript:pauseOrPlayrp()" id="rppp"><img src="./images/pause.png"></a>
		<a href="javascript:arrowRight()"><img src="./images/gogo.png"></a>
		<a href="javascript:arrowLeft()"><img src="./images/backback.png"></a>
...
document.getElementById("h31").innerHTML = Authentication.CTCGetConfig("name1").substr(0,13)+"...";
</script>
</body>
</html>
