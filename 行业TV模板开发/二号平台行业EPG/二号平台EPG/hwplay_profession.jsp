...
if('<%=stbtype%>' == "hw") {
	...
	top.location.href = host + '/VasToMem_pro_new.jsp?vas_info=<vas_action>play_vod</vas_action><mediacode><%=code%></mediacode><vas_back_url><%=returnurl_1%></vas_back_url><mediatype></mediatype><hwType><%=hwType%></hwType>';
	...
	window.location.href = "play_ehpt_profession.jsp?code=<%=code%>&backurl=<%=returnurl%>";
