...
if(stbtype == "hw") {
	...
	window.location.href = host + '/VasToMem_pro.jsp?vas_info=<vas_action>play_vod</vas_action><mediacode><%=code%></mediacode><vas_back_url><%=returnurl%></vas_back_url><mediatype></mediatype>';
   ...
   var last = epgdomain.lastIndexOf("/"); 
	...
	setCookie("num",'<%=num%>');
	var returnurl_1 = "http://218.24.37.2/templets/epg/myplay_ehpt_profession.jsp?returnurl=<%=returnurl%>";
