...
<%
    ...
    logger.info("key_department.jsp========"+"providerid:"+providerid+"iaspuserid:"+iaspuserid+" categoryid:"+categoryid);
    ...
    logger.info("key_department.jsp 获取节目列表的路径======="+url);
    ...
    if(null == res){
        ...
        logger.info("key_department.jsp jsonArrayCategory////////////////////////////////////////////"+jsonArrayCategory);

        logger.info("key_department.jsp count////////////////////////////////////////////"+count);
        ...
        logger.info("key_department.jsp 获取节目详情页信息的路径======="+finalpath);
        ...
        String finalres = "";
            ...
            logger.info("key_department.jsp 获取节目详情页数据源======="+finalres);
    ...
    logger.info("key_department.jsp backUrlEpg============="+backUrlEpg);
%>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body style="width:1280px; height:720px; background: url('img/bg2.jpg') no-repeat" onload="init();">
      <div id= "title" class="title">重点科室</div>  
      <div id="list">
      ...
      <script src="js/key_department.js"></script>
