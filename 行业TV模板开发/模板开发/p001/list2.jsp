...
<%
    ...
    if(request.getParameter("backUrlEpg")!=null){
        ...
        session.setAttribute("list2backUrl",backUrlEpg);
    }
    if ("".equals(backUrlEpg)) {
        backUrlEpg = (String)session.getAttribute("list2backUrl");
    }




    logger.info("list2.jsp========"+"providerid:"+providerid+"iaspuserid:"+iaspuserid+" categoryid:"+categoryid);
    ...
    logger.info("资讯列表页 list2.jsp 获取节目列表的路径======="+url);
    ...
    if(null == res){
        ...
        logger.info("list2.jsp jsonArrayCategory////////////////////////////////////////////"+jsonArrayCategory);

        logger.info("list2.jsp count////////////////////////////////////////////"+count);
        ...
        String finalres = "";
            ...
            logger.info("list2.jsp 获取节目详情页数据源======="+finalres);
    ...
    logger.info("资讯列表页 list2.jsp backUrlEpg============="+backUrlEpg);
%>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  function nextpage(){
    ...
    ++pageid;  
    window.location.href ="list2.jsp?categoryid="+categoryid+"&providerid="+providerid+"&iaspuserid="+iaspuserid+"&pageid="+pageid+"&backUrlEpg="+backUrlEpg;
  }
...
<body style="width:1280px; height:720px; background: url('img/bg2.jpg') no-repeat" onload="init()">
      ...
      <div id="list">
          ...
          <%
            ...
            %>
              ...
              for(int i =0;i<jsonArrayCategory.length();i++){
                ...
                <li><a id = "item<%=i%>" item ="<%=i%>" href="javascript:void(0)" onclick="play(this)"><img src="<%=fileurl%>" width="225" height="150"></a><p><%=name%></p></li>
                <%
              }%>        
          ...
          %>
              <li><a href="#"><img src="./img/tv.jpg" width="225" height="150"></a><p>精神病科精神病科精神病科精神病科</p></li>
              <li><a href="#"><img src="./img/tv.jpg" width="225" height="150"></a><p>精神病科</p></li>
              <li><a href="#"><img src="./img/tv.jpg" width="225" height="150"></a><p>精神病科</p></li>
              <li><a href="#"><img src="./img/tv.jpg" width="225" height="150"></a><p>精神病科</p></li>
              <li><a href="#"><img src="./img/tv.jpg" width="225" height="150"></a><p>精神病科</p></li>
              <li><a href="#"><img src="./img/tv.jpg" width="225" height="150"></a><p>精神病科</p></li>
