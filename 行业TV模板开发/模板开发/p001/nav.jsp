...
<%
    ...
    if(request.getParameter("backUrl")!=null){
        ...
        session.setAttribute("mainBackUrl",backUrl);
    }
    if ("".equals(backUrl) || backUrl == null) {
        backUrl = (String)session.getAttribute("mainBackUrl");
    }

    backUrl = backUrl.replace("*","&");
    logger.info("nav.jsp========"+"providerid:"+providerid+"iaspuserid:"+iaspuserid);
    logger.info("nav.jsp 二院首页返回地址========"+backUrl);

     logger.info("sesson"+session.getAttribute("backUrl"));
%>
...
<body style="width:1280px; height:720px; background: url('img/bg2.jpg') no-repeat">
    <div id = "test" style="position:absolute;left:30px;top:30px;z-index:9;">test</div>
    <div id="nav" data-area="nav">
       <ul id ="ulpp">
           <li class="move" ></li>
           <li class="move" ></li>
           <li class="move" ></li>
