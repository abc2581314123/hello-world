   ...
   if(state == true)
   {
    ...
    if(action=="1"){
      ...
      var falg = Authentication.CTCGetConfig("ProfessionFlag");
        if(falg=="true1111"){
      top.mainWin.document.location = "http://202.97.183.28:9090/templets/epg/Profession/professionEPG.jsp?providerid=zx&hdpath="+location.href;
        }
           ...
           top.mainWin.document.location = "http://202.97.183.28:9090/templets/epg/p001/main.jsp?providerid=zx&hdpath="+location.href;
        }
        else{
        top.jsEPGChange(url);
      }
