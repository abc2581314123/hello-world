...
function goToPlayChannel(ChannelNum)
{
    ...
    hwhref = host+"/channel_detail_pro.jsp?mixno="+ChannelNum+"&backUrl="+location.href; 
...
window.location.href = hwhref;
    ...
    var host = epgdomain.substr( 0, last );
     ...
     hwhref = host+"/ChanDirectAction_pro.jsp?chanNum="+ChannelNum+"&backUrl="+location.href;
