...
<head>
	...
	<script>
		...
		function loaddata(pagenum){
			...
			var riddle = hex_md5('besto' + testtime);
			var inputdata = document.getElementById("inputType").innerText;
			// var URL = "http://218.24.37.2/cms/es/esearchIptv_searchByType.do?time="+testtime+"&riddle="+riddle+"&pid="+pagenum+"&pagecount="+7+"&searchValue="+inputdata+"&providerid="+providerid+"&searchType="+searchType+"&resolution=";
			// var URL = "http://202.97.183.28:9090/cms/es/esearchIptv_searchByType.do?time="+testtime+"&riddle="+riddle+"&pid="+pagenum+"&pagecount="+7+"&searchValue="+inputdata+"&providerid="+providerid+"&searchType="+searchType+"&resolution=";
			if (categoryid == ''){
			    console.log("----forAll----categoryid------> " + categoryid);
                var URL = "http://202.97.183.28:9090/cms/es/esearchTrade_searchProgramForAll.do?time="+testtime+"&riddle="+riddle+"&pid="+pagenum+"&pagecount="+7+"&searchValue="+inputdata+"&providerid="+providerid+"&searchType="+searchType+"&resolution=";
			} else {
                console.log("----esearchTrade_searchProgram----categoryid------> " + categoryid);
                var URL = "http://202.97.183.28:9090/cms/es/esearchTrade_searchProgram.do?time=" + testtime + "&riddle=" + riddle + "&pid=" + pagenum + "&pagecount=" + 7 + "&searchValue=" + inputdata + "&searchCategoryId=" + categoryid + "&providerid=" + providerid + "&searchType=" + searchType + "&resolution=";
            }
    ...
    function Decrypt(word){  
       ...
       function H5_spstatistics(){
        var adlog ="";
         ...
         adlog ='http://202.97.183.77:91/loginterface/irts?platform=<%=providerid%>&version=1.5&userId=<%=iaspuserid%>&rtsType=4';
...
<body style="background:url(../ln-images-hd/search_Bg.jpg) no-repeat; width:1280px; height:720px;">
    ...
    <div class="switch">
		 <ul class="switchCol">
        	<li class="switchRow" attr="t9KeyPro" id="t9KeyB">按节目搜索</li>
    ...
    <!-- 初始化提示 -->
    <div id="snotice" style="position: absolute; left: 530px; top: 310px"><img src="../ln-images-hd/snotice.png"></div>
    ...
    <script src="../ln-js-hd/serach_trade2.js" charset="utf-8"></script>
	<script src="http://218.24.37.2:81/templets/epg/js/data/ad/iptv_sosohd.js" charset="GB2312"></script>
</body>
</html>