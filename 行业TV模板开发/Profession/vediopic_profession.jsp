...
if(boottype=="1"){
document.getElementById("img1").src = bootdetail;
}else{
    window.location.href = "http://202.97.183.28:9090/templets/epg/hwplay_profession_KJ.jsp?code="+bootdetail+"&videotype=<%=providerid%>";
}
setTimeout(function(){
    window.location.href = "professionEPG_zb.jsp?iaspuserid=<%=iaspuserid%>&iaspmac=<%=iaspmac%>&providerid=<%=providerid%>&hdpath=<%=hdpath%>";
},5000)
</script>
