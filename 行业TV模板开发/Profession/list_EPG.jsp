...
<body style="width:1280px; height:720px; background: url('img/body.jpg') no-repeat">
    <div id="searchDiv" class="search" style="position: absolute; top: 50px; left: 1190px;">搜索</div>
...
if(providerid == "hw") {
    ...
    var host = epgdomain.substr( 0, last );
     ...
     hwhref = host+"/ChanDirectAction_pro_new.jsp?chanNum=1";
   ...
   var last = hdpath.lastIndexOf("/"); 
    ...
    hwhref = host+"/channel_detail_pro_new.jsp?mixno=1"; 
}
   function keyBack(){
