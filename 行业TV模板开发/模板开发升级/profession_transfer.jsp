...
if ("".equals(providerid) || providerid == null) {
    ...
    String profession_url ="http://218.24.37.2/templets/epg/Profession/professionEPG.jsp?iaspuserid="+iaspuserid+"&iaspmac="+iaspmac+"&providerid="+providerid+"&hdpath="+hdpath;
