...
//二院返回backUrl addtime 20191028 start
function keyBack(){
	var professionTransferUrl = "";
	//返回跳转行业EPG中转页，重新判断首页
	if('CTCSetConfig' in Authentication) {
      professionTransferUrl = Authentication.CTCGetConfig("professionTransfer");  
             
   }else{
      professionTransferUrl = Authentication.CUGetConfig("professionTransfer");
       
   }
 
   if(null !=professionTransferUrl&&"null"!=professionTransferUrl&&"undefined"!=professionTransferUrl&&undefined!=professionTransferUrl){
   		window.location.href = professionTransferUrl;
   }

}

//二院返回backUrl addtime 20191028 end
