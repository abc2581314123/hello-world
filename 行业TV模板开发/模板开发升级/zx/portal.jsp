...
%>
   ...
   if ('CTCSetConfig' in Authentication) {
	...
	//20191028 add by rendd 添加二院首页判断
		...
		//二院跳转路径	
		top.mainWin.document.location = "http://218.24.37.2/templets/epg/profession_transfer.jsp?iaspuserid=<%=iaspuserid%>&iaspmac=<%=iaspmac%>&providerid=zx&hdpath="+location.href;;
	}
	else{
