...
function initAndShowData(type)
{
	...
	for(var i=0;i<typeCountTotal;i++)
	{
		...
		document.getElementById("li"+i).innerHTML = typeName;
	...
	for(var i=0;i<typeCountTotal;i++)
	{
		...
		chid.push(tempObj["channelcode"].substr(18))
		ids.push(id)
	...
	// sessionStorage.setItem('wn', chid)
	// sessionStorage.setItem('wn2', ids)
	setCookie('wn', chid)
	setCookie('wn2', ids)
}
